  ...
  return (
    <div className="about">
      <div className="aboutcontainer">
        ...
        trivago’s hotel search allows users to compare hotel prices in just a few clicks from more than 300 booking sites for more  in over 190 countries. We help millions of travelers each year compare deals for hotels and accommodations. Get information for weekend trips to cities like Mumbai or Bengaluru and you can find the right hotel on trivago quickly and easily. Delhi and its surrounding area are great for trips that are a week or longer with the numerous hotels available.
        </div>
      ...
      <div className="aboutcontainer">
        ...
        Let trivago help you to find the right price from over 300 booking sites!
        </div>
      </div>
